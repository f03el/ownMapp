            ...
            <div id="map" class="map">
                ...
                <div id="dialog-container" class="hide">
                    ...
                    <div class="hide dialog" id="help-dialog">
                            <h1>ownMapp Help</h1>
                            <p>ownMapp allows you to track your current location, save markers of static locations,
                    ...
                    <div class="hide dialog" id="settings-dialog">
                            <h1>Settings</h1>
                            <p>This is a placeholder for the settings panel. 
                            </p><p>
                                It will have all sorts of controls.
                            </p><p>
                                Really, I promise. It'll be great.
                            </p><p>                                
                            </p>
                    </div>
